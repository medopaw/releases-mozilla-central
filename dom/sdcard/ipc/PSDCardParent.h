...
#ifndef PSDCardParent_h
#define PSDCardParent_h
...
class /*NS_ABSTRACT_CLASS*/ PSDCardParent :
...
public:
    ...
    bool
    SendOnVoidResult() NS_WARN_UNUSED_RESULT;

    bool
    SendOnError() NS_WARN_UNUSED_RESULT;
